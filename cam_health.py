...
while True:
    try:
        ...
        if vcap1.read()[0] == True and vcap2.read()[0] == True and cam_check == False:
            print("cam1: True")
            print("cam2: True")
            # change flag status
            cam_check = True
        ...
        if vcap1.read()[0] == False and vcap2.read()[0] == False and cam_check == False:
            print("cam1: False")
            print("cam2: False")
            # change flag status
            cam_check = True
        ...
        if vcap1.read()[0] == True and vcap2.read()[0] == False and cam_check == False:
            print("cam1: True")
            print("cam2: False")
            #change flag status
            cam_check = True
        ...
        # if source 1 is giving output and source 2 is not giving output
        if vcap1.read()[0] == False and vcap2.read()[0] == True and cam_check == False:
            print("cam1: False")
            print("cam2: True")
            # change flag status
            cam_check = True
